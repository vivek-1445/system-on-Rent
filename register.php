...
if(isset($_POST['signup']))
{
    ...
    $insert_update = "insert into user(`name`,`email`,`password`,`conform_password`,`mobile`,`gender`,`user_type`)values 
                                      ('$name','$email','$password','$conform_password','$mobile','$gender','user')";
    ...
    <form  method="post" id="form" >
      ...
      <div class="form-group has-feedback">
        <input type="password" class="form-control" name="conform_password" id="conform_password" placeholder="Retype password"
               ...
               data-bv-identical-field="password" data-bv-identical-message="The password not matched." data-bv-field="confirm_password">
        <span class="glyphicon glyphicon-log-in form-control-feedback"></span>
      </div>

      <div class="form-group has-feedback">
        <input type="number" value="+" class=" form-control" name="mobile" placeholder="+91 Enter mobile number"
